...
#SBATCH -o seg11long.%N.%j.out
# Define a standard error file
#SBATCH -e seg11long.%N.%j.err
...
#SBATCH --mail-user=sgabenna@liverpool.ac.uk
...
conda activate YOLO11         # Activate the correct Conda environment
python3 /mnt/scratch/users/sgabenna/YOLO11-LSTM/train.py
